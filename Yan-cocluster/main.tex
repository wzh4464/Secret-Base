%%%
 ...
 % Author: Zihan
 % -----
 % Last Modified: Thursday, 21st September 2023 12:53:40 am
...
\begin{align*}
    P(S(I,J) \le \mathbb{E}(S(I,J)) - \epsilon) & \le \exp(-\frac{\epsilon^2}{2\sigma^2(S(I,J))}) \\
                                                 & \le \exp(-\frac{\epsilon^2}{2|I||J| \sigma^2 \exp(-\frac{2}{\alpha \max(||B||_1, ||B^\top||_1)})}) \\
                                                 & \le \exp(-\frac{\epsilon^2}{2|I||J| \sigma^2 \exp(-\frac{2}{\alpha \lambda})}) \\
\end{align*}

Thus if we set $\epsilon = \sqrt{2|I||J| \sigma^2 \exp(-\frac{2}{\alpha \lambda}) \log(1/\delta)}$, then

\begin{align*}
    P(S(I,J) \le \mathbb{E}(S(I,J)) - \epsilon) & \le \delta \\
\end{align*}
