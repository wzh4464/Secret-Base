%%%
 ...
 % Author: Zihan
 % -----
 % Last Modified: Monday, 4th September 2023 9:33:58 pm
...
\begin{align}
    ...
    % &=\frac{\partial}{\partial t_i} \bigg|_{t_i=0} \left( \exp \left(-\frac{1}{2} t^{\top} B t+i \mu^{\top} t\right) \left(-\frac{1}{2} b_{ij} t_j + i \mu_j \right) \right) \\
\end{align}
